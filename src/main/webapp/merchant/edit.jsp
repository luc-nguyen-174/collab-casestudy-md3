...
<h2>
    <a href="/merchants">Back To List</a>
</h2>
<form method="post">
    <table border="1" cellpadding="5">
        <caption>Edit Merchant</caption>
        <c:if test="${merchant != null}">
            <input type="hidden" name="id" value="<c:out value='${merchant.id}'/>"/>
        </c:if>
        <tr>
            <td>Name: </td>
            <td><input type="text" name="name" id="name" size="45"
                       value="<c:out value='${merchant.name}'/>"></td>
        </tr>
        <tr>
            <td>Age: </td>
            <td><input type="text" name="age" id="age" size="45"
                       value="<c:out value='${merchant.age}'/>"></td>
        </tr>
        <tr>
            <td>ID card: </td>
            <td><input type="text" name="id_number" id="id_number" size="45"
                       value="<c:out value='${merchant.id_number}'/>"></td>
        </tr>
        <tr>
            <td>Address: </td>
        ...
        <tr>
            ...
            <td><input type="text" name="phone" id="phone" size="45"
                       value="<c:out value='${merchant.phone}'/>"></td>
        </tr>
        <tr>
            <td>Email: </td>
            <td><input type="text" name="email" id="email" size="45"
                       value="<c:out value='${merchant.email}'/>"></td>
        </tr>
        <tr>
            <th>Active?</th>
